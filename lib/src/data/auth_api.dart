...
class AuthApi {
  ...
  Future<EmployeeUser> initializeApp() async {
    final User? user = _auth.currentUser;
    final DocumentSnapshot result = await _firestore.doc('employees/${user!.uid}').get();
    return EmployeeUser.fromJson(result.data());
  }
}
